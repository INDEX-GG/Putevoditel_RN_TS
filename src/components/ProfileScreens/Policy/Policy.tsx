...
//Согласие Пользователя
// на обработку персональных данных
// В соответствии со статьями 23, 24 Конституции Российской Федерации, Федеральным законом от 27.07.2006 No 152-ФЗ «О персональных данных», Политикой конфиденциальности, размещенной в мобильном приложении «Услуги в кармане». (далее-Политика конфиденциальности),
// Я, субъект персональных данных, именуемый в дальнейшем Пользователь, отправляя информацию через формы обратной связи (далее, каждая из них и все в совокупности-Форма, Формы) при прохождении процедуры регистрации в целях использования мобильного приложения «Услуги в кармане» и его сервисов (далее- Мобильное приложение, Сервис), и в дальнейшем при использовании Мобильного приложения и/или его Сервисов, выражаю полное, безоговорочное и однозначное Согласие на обработку моих персональных данных (далее-Согласие) на следующих условиях:
// 1. Согласие выдано КУ РА «УСПН Майминского района» (ОГРН 1110411005396, ИНН 0411157921, КПП 041101001, Республика Алтай, Майминский район, село Майма, улица Ленина, дом 8А), (далее-Оператор).
...
// - фамилия, имя, отчество, адрес электронной почты (e-mail), номер телефона, другая аналогичная информация, сообщённая о себе Пользователем Мобильного приложения, на основании которой возможна его идентификация как субъекта персональных данных.
// - данных, которые автоматически передаются в процессе просмотра и при посещении страниц Мобильного приложения: IP адрес, информация из cookies, информация о браузере, время доступа, адрес посещаемой страницы, реферер (адрес предыдущей страницы);
// - статистики о моих IP-адресах.
// 3. Согласие выдано на обработку персональных данных в целях:
// 3.1. Общество руководствуется конкретными, заранее определенными целями обработки ПДН, в соответствии с которыми ПДН были предоставлены Субъектом, в частности:
// 3.1.1. Обеспечение защиты прав и свобод Субъекта при обработке его ПДН;
// 3.1.2. Ведение бухгалтерского учета и отчетности;
// 3.1.3. Обеспечение Пользователю возможности взаимодействовать с
// Мобильным приложением, в частности направление уведомлений, запросов и информации, связанных с оказанием услуг, а также обработка запросов и заявок от Пользователя, предоставление доступа к персонализированным ресурсам Мобильного приложения, предоставления Пользователю специальных предложений, любых информационных сообщений, включая рекламу и иных сведений от имени Мобильного приложения или от имени партнеров Мобильного приложения, предоставления доступа Пользователю в мобильное приложение или сервисы партнеров Мобильного приложения, в соответствии с Пользовательским соглашением;
// 3.1.4. Оказания услуг курьерской доставки Клиентам в рамках договора возмедного оказания курьерских услуг;
// 3.1.5. Ведение уставной деятельности Общества в части заключения, учета и исполнения договоров с контрагентами (Заказчики, Подрядчики, Исполнители и т.п.);
//
// 3.1.6. Проведение опросов и исследований, направленных на выявление удовлетворенности/неудовлетворенности Клиента услугами Общества, улучшение качества услуг;
...
// 5. Настоящим, Пользователь подтверждает, что:
// 5.1. Ознакомлен и согласен с тем, что передача персональных данных Пользователя может осуществляться Оператором в объеме, необходимом для получения Пользователем доступа к Мобильному приложению, его Содержанию и/или его Сервису.
...
// 6. Согласие вступает в силу с момента его отправки и может быть отозвано Пользователем путем направления письменного заявления в произвольной форме в адрес Оператора по адресу электронной почты yurist.maima@mail.ru либо иным способом, позволяющим однозначно определить факт его получения адресатом.
// 7. Согласие действует в течение неопределенного срока до момента его отзыва Пользователем. Согласие прекращает свое действие с даты, указанной в заявлении Пользователя об отзыве Согласия на обработку персональных данных, но не ранее даты, следующей за датой фактического получения Оператором отзыва Согласия.
...
//
// соответствующую кнопку) в Форме и/или нажатие на кнопку отправки Формы на любой странице Мобильного приложения и/или его Сервиса.
// 9. Руководствуясь ч. 4 ст. 9 Федерального закона от 27.07.2006 No 152-ФЗ «О персональных данных», направляю через личное мобильное устройство путем прикрепления к специальной форме или при заполнении соответствующих полей такой формы при прохождении процедуры регистрации в Мобильном приложении свои персональные данные.
